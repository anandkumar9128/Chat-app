...
const LoginPage = () => {
  const [currState, setCurrState] = useState("Sign up") // login or signup
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* Right -> loginform or signup form */}
      ...
      <form onSubmit={onSubmitHandler} action="" className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg '>
        ...
        )}
        {
          currState==="Sign up" && isDataSubmitted &&(
            ...
            placeholder='Provide a short Bio...' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'/>
          )
        }
        <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white cursor-pointer'>
