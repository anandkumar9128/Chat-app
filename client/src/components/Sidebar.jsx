...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      ${selectedUser ? 'md:block hidden' : ''} border-r border-white/10`}
    >
      <div className='pb-5'>
        {/* Header */}
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          <div
            ...
            className={`
              relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer 
              max-sm:text-sm transition 
              ${selectedUser && String(selectedUser._id) === String(user._id) ? 'bg-[#282142]/50' : ''}
            `}
          >
            <img
